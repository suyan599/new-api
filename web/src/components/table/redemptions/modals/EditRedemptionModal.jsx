...
const EditRedemptionModal = (props) => {
  ...
  const submit = async (values) => {
    ...
    localInputs.random_mode = randomMode;
                    ...
                    <div className='mb-4 p-3 bg-gray-50 rounded-lg'>
                      <div className='flex items-center justify-between mb-2'>
                        <div className='flex items-center'>
                          <IconShuffle className='mr-2 text-blue-500' size={16} />
                          <Text className='font-medium'>{t('随机额度模式')}</Text>
                        </div>
                        <Switch
                          checked={randomMode}
                          ...
                          <Form.AutoComplete
                            ...
                            rules={[
                              { required: true, message: t('请输入最大额度') },
                              {
                                validator: (rule, v) => {
                                  const num = parseInt(v, 10);
                                  const minQuota = parseInt(values.min_quota, 10) || 0;
                                  return num > minQuota
                                    ? Promise.resolve()
                                    : Promise.reject(t('最大额度必须大于最小额度'));
                                },
                              },
                            ]}
                            extraText={renderQuotaWithPrompt(
